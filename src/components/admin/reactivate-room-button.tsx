...
import { reactivateRoom } from "@/app/(admin)/admin/rooms/actions";

interface Props {
  roomId: string;
}

export default function ReactivateRoomButton({ roomId }: Props) {
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      try {
        ...
        setError(e instanceof Error ? e.message : "Could not reactivate room.");
      }
    });
  }
